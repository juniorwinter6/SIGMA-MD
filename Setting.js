...
global.devs  = "2349130961572";
global.inrl_key = `inrl-bot-mdaqz3ks6md7`;
global.inrl_api = `https://upper-romy-inrl-bot.koyeb.app/`;
global.blockJids = process.env.BLOCK_JID ||'120363169665426586@g.us' ;
global.allowJids = process.env.ALLOW_JID ||'120363169665426586@g.us' ;
global.email     = 'juniorwinter16@gmail.com' ; 
global.github    = 'https://github.com/juniorwinter6/SIGMA-MD' ;
global.location  = 'Lagos, Nigeria' ;
global.website   = 'https://chat.whatsapp.com/LHWGPUZkUKmLbGFXMXxRJO' ; 
...
global.owner = process.env.OWNER_NUMBER  || '2349130961572' ;  // ADD YOUR NUMBER WITHOUT +
global.mongodb = process.env.MONGODB_URI || "mongodb+srv://juniorwinter:200416@cluster0.czrj8ug.mongodb.net/?retryWrites=true&w=majority" ;            // PUT MONGODB KEY HERE, WITHOUT MONGODB YOUR BOT WILL NOT RUN
...
global.sudo  =  process.env.SUDO || "2349130961572" ;          // DON'T REMOVE
global.mztit = process.env.MZTIT ||"🅼♥︎❚❚♥︎🆉",               // ADD YOUR TITLE, ONE WORD WILL BE MORE BETTER
global.gurl  = 'https://chat.whatsapp.com/LHWGPUZkUKmLbGFXMXxRJO' ; 
...
module.exports = {
  ...
  botname: process.env.BOT_NAME       || 'Aneesha',         // ADD YOUR BOT NAME
  ownername:  process.env.OWNER_NAME  || `Rise`, // ADD YOUR NAME
  ...
  //==============================[WHAT'SAPP FEATURES]==============================
  author:  process.env.PACK_AUTHER  || 'Rise',      // ADD YOUR STICKER AUTHOR NAME
  ...
  packname:  process.env.PACK_NAME  || "Aneesha" ,          // ADD YOUR STICKER PACKNAME
  ...
  OPENAI_API_KEY: process.env.OPENAI_API_KEY ||'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' ,    // ADD YOUR OPEN AI KEY IF YOU HAVE
